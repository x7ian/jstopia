...
<Callout kind="note" title="Try this in CODE">
Open the CODE panel to run the "Anchor Rope" example for this step.
</Callout>
</DocBlock>
...
<Callout kind="note" title="Try this in CODE">
Open the CODE panel to run the "Mutation vs Reassignment" example for this step.
</Callout>
</DocBlock>
